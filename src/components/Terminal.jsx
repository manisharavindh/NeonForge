...
const Terminal = ({ isFullScreen = false, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-50 flex flex-col bg-cyberpunk-darker border border-neon-accent/50 overflow-hidden hidden md:flex"
        style={{
          backgroundColor: '#0f0f1e',
        }}
      >
        {/* Terminal Header - macOS-style */}
        <div className="bg-cyberpunk-dark border-b border-neon-accent/30 px-8 py-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-4">
            {/* <div className="flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-neon-muted" />
              <div className="w-3 h-3 rounded-full bg-neon-purple" />
              <div className="w-3 h-3 rounded-full bg-neon-accent" />
            </div> */}
            <span className="text-sm text-neon-accent font-bold ml-2">neonforge@localhost</span>
          </div>
          <button
            onClick={onClose}
            className="text-neon-accent hover:text-neon-light transition-colors text-sm font-bold"
          >
            [-close-]
          </button>
        </div>
        ...
        <div
          ...
          style={{
            background: `
              linear-gradient(to bottom, rgba(167, 139, 250, 0.05), transparent),
        ...
        >
          {output.length === 0 ? (
            <div className="text-neon-accent/70 text-base h-full flex items-center justify-center font-mono">
        ...
        <div className="border-t border-neon-accent/30 bg-cyberpunk-dark/60 px-8 py-4 flex-shrink-0 backdrop-blur-sm">
          <div className="flex items-baseline gap-2 font-mono text-sm">
            <span className="text-neon-accent font-bold flex-shrink-0">➜</span>
            {/* <span className="text-neon-purple flex-shrink-0">~/portfolio</span> */}
            <span className="text-neon-accent flex-shrink-0">$</span>
            <input
              ref={inputRef}
              type="text"
              value={input}
              ...
              className="flex-1 bg-transparent text-neon-accent outline-none font-mono text-sm caret-neon-accent border-none"
              placeholder=""
              spellCheck="false"
              autoFocus
              style={{
            ...
            />
            <span className="text-neon-accent animate-pulse flex-shrink-0">▮</span>
          </div>
        </div>
      </div>
    </>

...
const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-neon-green to-neon-accent text-slate-900 hover:shadow-neon-green hover:shadow-xl scale-100 hover:scale-105 font-bold',
    secondary: 'border-2 border-neon-accent text-neon-accent hover:bg-neon-accent/10 hover:shadow-glow-md',
